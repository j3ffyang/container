...
```
ubuntu@vantiq-test01:~/cluster_resource.yaml$ cat create_pvc.yaml
apiVersion: v1
kind: PersistentVolumeClaim
metadata:
  creationTimestamp: "2019-05-02T10:04:56Z"
  finalizers:
  - kubernetes.io/pvc-protection
  labels:
    app: test-pvc
  name: my-pvc-test-pvc-0
  namespace: default
  resourceVersion: "785692"
  selfLink: /api/v1/namespaces/default/persistentvolumeclaims/my-pvc-test-pvc-0
  uid: bca66d1d-6cc1-11e9-a3a8-fa163edae6af
spec:
  storageClassName: local-storage
  accessModes:
  - ReadWriteOnce
