...
> Reference > https://docs.fluxcd.io/en/latest/introduction.html and https://github.com/fluxcd/flux

<img src="../imgs/20190909_flux-cd-diagram.png">
...
#### Check Tiller's status and find the following error due to GFW
...
The workaround is to place ```tiller.tar``` into specific k3s' images path on __each__ agent/ worker
```bash
